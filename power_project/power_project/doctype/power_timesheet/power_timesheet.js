...
frappe.ui.form.on("Power Timesheet", {
	setup: function (frm) {
	...
	make_invoice: function (frm) {
		...
		dialog.set_primary_action(__("Create Sales Invoice"), () => {
			...
			return frappe.call({
				type: "GET",
				method: "power_project.power_project.doctype.power_timesheet.power_timesheet.make_sales_invoice",
				args: {
...
frappe.ui.form.on("Power Timesheet Detail", {
	...
	activity_type: function (frm, cdt, cdn) {
		...
		frappe.call({
			method: "power_project.power_project.doctype.power_timesheet.power_timesheet.get_activity_cost",
			args: {
